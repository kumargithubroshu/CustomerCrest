...
import com.springboot.CRUD.helper.FileUploadHelper;
...
public class FileUploadController {
	...
	{
		System.out.println(file.getOriginalFilename());                 // Roshan_Image.jpeg
		System.out.println(file.getContentType());                     //  image/jpeg
		System.out.println(file.getSize());                           //  157736
		System.out.println(file.getName());                          //   file
		try {
			System.out.println(file.getInputStream().available());  //157736
		} catch (IOException e) {
			e.printStackTrace();
		}
